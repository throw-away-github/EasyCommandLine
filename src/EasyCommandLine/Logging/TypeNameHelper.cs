...
{
    // waiting for UnsafeAccessorType to access internal class: https://github.com/dotnet/runtime/issues/90081
    // eventually the whole copy of TypeNameHelper will be removed and replaced with the below extern method
    // [UnsafeAccessor(UnsafeAccessorKind.StaticMethod)]
    // [return: UnsafeAccessorType("B, AssemblyName")]
    // public static extern string GetTypeDisplayName(Microsoft.Extensions.Internal.TypeNameHelper type, bool fullName = true, bool includeGenericParameterNames = false, bool includeGenericParameters = false, char nestedTypeDelimiter = '.')
    ...
    private static string? ProcessType(ref StringBuilder? builder, Type type, in DisplayNameOptions options)
    {
        ...
        {
            if (!options.IncludeGenericParameterNames) return null;
        ...
        else
        {
            ...
            if (options.NestedTypeDelimiter != DefaultNestedTypeDelimiter)
                builder.Replace(DefaultNestedTypeDelimiter,
        ...
        in DisplayNameOptions options)
    {
        ...
        if (!options.IncludeGenericParameters) return;
        builder.Append('<');
    ...
    {
        public DisplayNameOptions(bool fullName,
